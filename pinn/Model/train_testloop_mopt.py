...
def training_loop(epochs1, epochs2,model, \
                  loss_fn_data, optimizer1, optimizer2, \
    ...
    for epoch in range(epochs1):
        ...
        for (batch, batch_pde, batch_init, batch_left, batch_right) in \
            ...
            optimizer1.zero_grad()  # Zero the gradients before backpropagation
            ...
            if optimizer1.__class__ == torch.optim.Adam:
    ...
    # return train_losses, test_losses, pde_losses, bc_losses, ic_losses, data_losses
        ...
        # logger.info(f"{epoch1+1}, {train_loss:.4e}, {test_loss:.4e}, {data_loss_b:.4e}, \
    ...
    for epoch in range(epochs2):
        ...
        for (batch, batch_pde, batch_init, batch_left, batch_right) in \
            ...
            optimizer2.zero_grad()  # Zero the gradients before backpropagation
            ...
            if optimizer2.__class__ == torch.optim.Adam:
